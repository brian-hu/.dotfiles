...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch rofi
    , ((modm                , xK_p      ), spawn "rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/rounded/scripts/rofi/launcher.rasi")
    ...
    -- Power options
    , ((modm .|. shiftMask  , xK_s      ), spawn "zsh ~/.config/polybar/rounded/scripts/powermenu.sh")
    ...
    -- Restart xmonad
    , ((modm                , xK_q      ), spawn ("usr/bin/xmonad --recompile; usr/bin/xmonad --restart"))
...
help = unlines [
    ...
    "mod-comma  (mod-,)   Increment the number of widows in the master area",
